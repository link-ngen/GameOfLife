...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  set_property -dict [ list \
CONFIG.C_GOL_HEIGHT {12} \
CONFIG.C_GOL_WIDTH {18} \
 ] $game_of_life_0
...
CONFIG.C_I_LMB {1} \
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
