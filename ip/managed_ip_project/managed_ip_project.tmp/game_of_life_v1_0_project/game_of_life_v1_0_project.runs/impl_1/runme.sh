...
HD_PWD='C:/Workspace/GameOfLife/ip/managed_ip_project/managed_ip_project.tmp/game_of_life_v1_0_project/game_of_life_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_of_life_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_of_life_v1_0.tcl -notrace
