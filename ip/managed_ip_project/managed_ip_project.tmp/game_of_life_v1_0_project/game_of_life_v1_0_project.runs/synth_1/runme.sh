...
HD_PWD='C:/Workspace/GameOfLife/ip/managed_ip_project/managed_ip_project.tmp/game_of_life_v1_0_project/game_of_life_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_of_life_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_of_life_v1_0.tcl
