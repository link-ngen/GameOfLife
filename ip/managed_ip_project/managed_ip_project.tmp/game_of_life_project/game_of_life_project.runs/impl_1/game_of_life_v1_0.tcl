...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Workspace/GameOfLife/ip/managed_ip_project/managed_ip_project.tmp/game_of_life_project/game_of_life_project.cache/wt [current_project]
  set_property parent.project_path C:/Workspace/GameOfLife/ip/managed_ip_project/managed_ip_project.tmp/game_of_life_project/game_of_life_project.xpr [current_project]
  set_property ip_repo_paths C:/Workspace/GameOfLife/ip/game_of_life_1.0 [current_project]
  set_property ip_output_repo C:/Workspace/GameOfLife/ip/managed_ip_project/managed_ip_project.tmp/game_of_life_project/game_of_life_project.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet C:/Workspace/GameOfLife/ip/managed_ip_project/managed_ip_project.tmp/game_of_life_project/game_of_life_project.runs/synth_1/game_of_life_v1_0.dcp
