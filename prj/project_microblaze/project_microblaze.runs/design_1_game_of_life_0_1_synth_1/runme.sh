...
HD_PWD='C:/Project/GameOfLife/prj/project_microblaze/project_microblaze.runs/design_1_game_of_life_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_game_of_life_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_game_of_life_0_1.tcl
