...
HD_PWD='C:/Workspace/GameOfLife/prj/project_microblaze/project_microblaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gol_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_gol_wrapper.tcl
