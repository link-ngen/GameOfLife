...
set rc [catch {
  ...
  add_files C:/Project/GameOfLife/bd/design_1/design_1.bd
  set_property is_locked true [get_files C:/Project/GameOfLife/bd/design_1/design_1.bd]
  set_param project.isImplRun false
  read_xdc C:/Project/GameOfLife/constraints/zed_pins.xdc
  set_param project.isImplRun true
