...
HD_PWD='C:/Project/GameOfLife/prj/project_cell/project_cell.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cell.tcl -notrace
